...
class LoginSetupRoute extends _i6.PageRouteInfo<void> {
  const LoginSetupRoute({List<_i6.PageRouteInfo>? children})
...
class OrganizationSetupRoute
    extends _i6.PageRouteInfo<OrganizationSetupRouteArgs> {
...
class PasswordSetupRoute extends _i6.PageRouteInfo<PasswordSetupRouteArgs> {
  PasswordSetupRoute({
    _i7.Key? key,
    required String userName,
    required String userEmail,
...
/// generated route for
/// [_i5.RegisterSetupScreen]
class RegisterSetupRoute extends _i6.PageRouteInfo<void> {
  const RegisterSetupRoute({List<_i6.PageRouteInfo>? children})
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    name,
    builder: (data) {
      return const _i5.RegisterSetupScreen();
    },
  );
}
